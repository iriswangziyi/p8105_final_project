...
The state with the lowest barrel production in West Virginia  (`r round(cans_bottles$mean_barrel[cans_bottles$state == "West Virginia"],2)`), South Dakota  (`r round(cans_bottles$mean_barrel[cans_bottles$state == "South Dakota"],2)`), and North Dakota  (`r round(cans_bottles$mean_barrel[cans_bottles$state == "North Dakota"],2)`). 
