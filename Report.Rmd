...
```{r warning = FALSE, message =FALSE, fig.width = 6, fig.height = 4, cache=TRUE}
...
```{r warning=FALSE, message=FALSE, cache=TRUE, fig.width = 6, fig.height = 4}
...
The state with the least amount of barrel production in North Dakota (`r round(barrel$mean_barrel[barrel$state == "North Dakota"],2)`)
...
- [TTB.gov](https://www.ttb.gov/alcohol/beverage-alcohol)
- The Lady Tasting Tea by David Salsurg (page 26-28)
- [TTB.gov—Beer Statistics. (n.d.). Retrieved November 6, 2020]( https://www.ttb.gov/beer/statistics)
- [TTB.gov—Beer Alcohol. (n.d.). Retrieved November 6, 2020]( https://www.ttb.gov/alcohol/beverage-alcohol)
- [Beer Institute](https://www.beerinstitute.org/beer-policy/overview/) 
- [Open Beer Dataset. (n.d.). Retrieved November 6, 2020](https://data.opendatasoft.com/explore/dataset/open-beer-database%40public-us/table/)
- [Beer & American History](https://www.beerinstitute.org/news-media/additional-beer-resources/beer-american-history/ )
- [KPMG](https://www.nbwa.org/sites/default/files/NBWA_Report_2009.pdf)
- [Beer Tax Facts](https://www.finance.senate.gov/imo/media/doc/Beer%20Institue%204.pdf) 
- [American’s Beer Distributor](https://www.nbwa.org/government/state-policy-issues) 
- [Beer franchise law](https://www.nbwa.org/government/benefits-of-beer-franchise-laws)
- [Alcohol Law Review](https://www.alcohollawreview.com/category/alcohol-regulation/)
