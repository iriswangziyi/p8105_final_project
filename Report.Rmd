...
* What is the cumulative taxation over time in each state?
* What is the (average) tax per barrel over time in each state?
...
- [TTB.gov Statistics]( https://www.ttb.gov/beer/statistics)
- [Beer Institute](https://www.beerinstitute.org/beer-policy/overview/) 
- [Open Beer Dataset](https://data.opendatasoft.com/explore/dataset/open-beer-database%40public-us/table/)
