---
title: "Proposal: An Exhaustive look at Beer data"
...
1. How much profit and product does each state in the US make each year? 
2. How does the tax rate change over time per state? Which state gives more beer tax? Any trends?
3. What category/brewer/style of beer has the most Alcohol by volume (ABV)? 
4. Map location of each US brewer with category/style, size of marker showing ABV and interactive label showing the tax info by state.
