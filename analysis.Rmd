...
Our data showed **no significant difference between the two jurisdiction groups** in the **cumulative tax collected** and in the **tax per barrel** from 2010 to 2019. 
...
We first focus on the **cumulative tax collected**. 
...
* **Cumulative tax collected** is estimate to 
  ...
  * **increase approximately 1k for one unit increase in consumption per capital**, holding the group, year, shipments, and population unchanged. 
...
We next look at the **tax per barrel**. 
